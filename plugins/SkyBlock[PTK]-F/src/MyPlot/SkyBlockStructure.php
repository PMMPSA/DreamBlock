...
class SkyBlockStructure extends Populator{
	...
	public static function placeObject(ChunkManager $level, $chunk, $Xofchunk, $Zofchunk){
		...
		$level->setBlockIdAt($vec->x + 10, 68, $vec->z + 8, Block::FENCE);
		$level->setBlockIdAt($vec->x + 10, 68, $vec->z + 9, Block::FENCE);
		$level->setBlockIdAt($vec->x + 10, 68, $vec->z + 7, Block::FENCE);
		$level->setBlockIdAt($vec->x + 10, 68, $vec->z + 6, Block::FENCE);
		$level->setBlockIdAt($vec->x + 9, 68, $vec->z + 8, Block::COBBLESTONE);
