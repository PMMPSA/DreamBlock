...
class Main extends PluginBase implements Listener{
	...
	public function onLoad(){
		$this->getLogger()->info(TextFormat::GREEN . "MagicWE Đang Tải!");
	}
	...
	public function onEnable(){
		...
		$this->getLogger()->info(TextFormat::GREEN . "MagicWE Đã Kích Hoạt!");
	}
	...
	public function onCommand(CommandSender $sender, Command $command, $label, array $args){
		if($sender instanceof Player){
			switch($command){
				...
				case "/1":
					{
						if(!$sender->hasPermission("magicwe.command.pos1") && !$sender->hasPermission("we.command.admin")) return;
						...
						$sender->sendMessage(TextFormat::GREEN . "[MagicWE] Vị Trí Đầu Được Đặt Ở x:" . $pos1x . " y:" . $pos1y . " z:" . $pos1z);
						return true;
						break;
					}
				...
				case "/2":
					{
						if(!$sender->hasPermission("magicwe.command.pos2") && !$sender->hasPermission("we.command.admin")) return;
						...
						$sender->sendMessage(TextFormat::GREEN . "[MagicWE] Vị Trí Thứ Hai Được Đặt Ở x:" . $pos2x . " y:" . $pos2y . " z:" . $pos2z);
						return true;
						break;
					}
				...
				case "set":
					{
						if(!$sender->hasPermission("magicwe.command.set") && !$sender->hasPermission("we.command.admin")) return;
						if(isset($args[0])){
				...
				case "/replace":
					{
						if(!$sender->hasPermission("magicwe.command.replace") && !$sender->hasPermission("we.command.admin")) return;
				...
				case "/c":
					{
						if(!$sender->hasPermission("magicwe.command.copy") && !$sender->hasPermission("we.command.admin")) return;
						if(isset($this->pos1[$sender->getName()], $this->pos2[$sender->getName()])){
							$this->copy($sender);
							return true;
						}
				...
				case "/p":
					{
						if(!$sender->hasPermission("magicwe.command.paste") && !$sender->hasPermission("we.command.admin")) return;
						if(isset($this->pos1[$sender->getName()], $this->pos2[$sender->getName()])){
							$this->paste($sender);
							$sender->getLevel()->doChunkGarbageCollection();
							return true;
				...
				case "/undo":
					{
						if(!$sender->hasPermission("magicwe.command.undo") && !$sender->hasPermission("we.command.admin")) return;
				...
				case "/redo":
					{
						if(!$sender->hasPermission("magicwe.command.redo") && !$sender->hasPermission("we.command.admin")) return;
				...
				case "/flip":
					{
						if(!$sender->hasPermission("magicwe.command.flip") && !$sender->hasPermission("we.command.admin")) return;
				...
				case "wand":
					{
						if(!$sender->hasPermission("magicwe.command.wand") && !$sender->hasPermission("we.command.admin")) return;
						if(empty($this->wand[$sender->getName()]) || $this->wand[$sender->getName()] === 0){
							$this->wand[$sender->getName()] = 1;
							$sender->sendMessage(TextFormat::GREEN . "[MagicWE] Wand Đã Dược Bật");
						}
						else{
				...
				case "/schem":
					{
						if(!$sender->hasPermission("magicwe.command.schem") && !$sender->hasPermission("we.command.admin")) return;
				...
				case "/cyl":
					{
						if(!$sender->hasPermission("magicwe.command.cyl") && !$sender->hasPermission("we.command.admin")) return;
				...
				case "/hcyl":
					{
						if(!$sender->hasPermission("magicwe.command.hcyl") && !$sender->hasPermission("we.command.admin")) return;
						if(isset($args[0], $args[1])){
							#$this->fill($sender, $args[0]);
	...
	public function wandPos1(BlockBreakEvent $event){
		...
		if($sender->hasPermission("magicwe.command.wand") && $sender->getInventory()->getItemInHand()->getId() === Item::WOODEN_AXE && $this->wand[$sender->getName()] === 1){
			...
			$sender->sendMessage(TextFormat::GREEN . "[MagicWE] Vị Trí Đầu Được Đặt Ở x:" . $block->x . " y:" . $block->y . " z:" . $block->z);
			$event->setCancelled();
		}
	}
	...
	public function wandPos2(PlayerInteractEvent $event){
		...
		if($sender->hasPermission("magicwe.command.wand") && $sender->getInventory()->getItemInHand()->getId() === Item::WOODEN_AXE && $this->wand[$sender->getName()] === 1){
			...
			$sender->sendMessage(TextFormat::GREEN . "[MagicWE] Vị Trí Thứ Hai Được Đặt Ở x:" . $block->x . " y:" . $block->y . " z:" . $block->z);
			$event->setCancelled();
		}
	}
